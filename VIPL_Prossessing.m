...
Lmk_root_path = 'C:\Users\samal\Desktop\HR_landmarks\SDK_smooth';
% vedio path
video_root_path = 'C:\Users\samal\Desktop\p1-5';
save_path ='C:\Users\samal\Desktop\matlabtest\';
% person index
        ...
        for s_index = 1:length(s_real)
            ...
            if numFrames==numlandmarks && numFrames>520
                ...
                if (fps > 15)
                    ...
                    % save wave as pic
                    %(wave,numFrames,dst_path);
                    % save STmap as pic
                    STMap(vidio_path, landmark_path, dst_path, fps);
                    % save HR,SpO2,fps
%                     % spline HR/SPO2
%                     HR_size = size(HR);
%                     SpO2_size = size(SpO2);
